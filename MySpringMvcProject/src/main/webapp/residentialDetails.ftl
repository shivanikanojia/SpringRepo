	...
	<table id="example" class="display" text-align:center">
        <thead>
            <tr class="row">
                ...
                <th class="col-sm-2">Line1</th>
                <th class="col-sm-2">Line2</th>
         ...
         <#list addresses as address>
    		<tr class="row">
    			<td class="col-sm-2">${address?index}</td>
        		<td class="col-sm-2">${address.line1}</td>
        		<td class="col-sm-2">${address.line2}</td> 
        		<td class="col-sm-2">${address.city}</td>
        		<td class="col-sm-2">${address.state}</td> 
        		<td class="col-sm-2">${address.zipcode}</td>
